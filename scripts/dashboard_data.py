...
DATASETS = [
    DatasetConfig(
        id="kmhv3-spec06-rva23-novec-gcc16-0.3c",
        label="kmhv3 / gcc16 RVA23 no-vector / SPEC06 0.3c",
        config_name="kmhv3",
        toolchain="gcc16",
        coverage="0.3c",
    ...
    DatasetConfig(
        id="idealkmhv3-spec06-rva23-novec-gcc16-0.3c",
        label="idealkmhv3 / gcc16 RVA23 no-vector / SPEC06 0.3c",
    ...
    DatasetConfig(
        id="weekly-kmhv3-spec06-rva23-novec-gcc16-1.0c",
        label="weekly kmhv3 / gcc16 RVA23 no-vector / SPEC06 1.0c",
        config_name="kmhv3",
        toolchain="gcc16",
        coverage="1.0c",
    ...
    DatasetConfig(
        id="weekly-idealkmhv3-spec06-rva23-novec-gcc16-1.0c",
        label="weekly idealkmhv3 / gcc16 RVA23 no-vector / SPEC06 1.0c",
        config_name="idealkmhv3",
        toolchain="gcc16",
        coverage="1.0c",
        workflow_name="gem5 Ideal BTB Weekly Performance Test",
    ...
    DatasetConfig(
        id="weekly-kmhv3-gcc15-spec26-1.0c",
        label="weekly kmhv3 / gcc15 / SPEC26 1.0c",
        config_name="kmhv3",
        toolchain="gcc15",
        coverage="1.0c",
        workflow_name="gem5 Ideal BTB Weekly Performance Test",
    ...
    DatasetConfig(
        id="weekly-idealkmhv3-gcc15-spec26-1.0c",
        label="weekly idealkmhv3 / gcc15 / SPEC26 1.0c",
        config_name="idealkmhv3",
        toolchain="gcc15",
        coverage="1.0c",
        workflow_name="gem5 Ideal BTB Weekly Performance Test",
    ...
    DatasetConfig(
        id="weekly-idealkmhv3-gcc12-spec06-dynpf-1.0c",
        label="weekly idealkmhv3 / gcc12 / SPEC06 1.0c / dynamic PF (SMT baseline)",
        config_name="idealkmhv3",
        toolchain="gcc12",
        coverage="1.0c",
        workflow_name="gem5 Ideal BTB Weekly Performance Test",
