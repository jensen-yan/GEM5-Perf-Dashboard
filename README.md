...
- Separate recent history for `gcc12`, `gcc15`, and GCC16 RVA23 no-vector data
...
- `kmhv3-spec06-rva23-novec-gcc16-0.3c`
- `idealkmhv3-spec06-rva23-novec-gcc16-0.3c`
...
merged into one trend line. Configured datasets with no collected points are kept in the
generated data but hidden from selectors until their first successful result arrives.
